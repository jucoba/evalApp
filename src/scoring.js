...
export function calcAttendance(attendeeCount, memberCount) {
  if (!memberCount || memberCount === 0) return 0
  return Math.round((attendeeCount / memberCount) * 10 * 10) / 10
}

export function calcWorkshopTotal(attendancePts, grade, daysLate) {
...
export function getPrizeTier(total) {
